...
class _AddPostScreenState extends State<AddPostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return _file == null
        ...
        : Scaffold(
            //this is else condition of _file==null
            appBar: AppBar(
              backgroundColor: mobileBackgroundColor,
              leading: IconButton(
                icon: const Icon(Icons.arrow_back),
                onPressed:
                    clearImage, //we return to just upload icon when _file=null
              ),
              title: const Text('Post to'),
              centerTitle: false, //makes 'Post to' non centered
              actions: [
                TextButton(
                    onPressed: () =>
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        maxLines:
                            8, // It allows the TextField to have multiple lines, making it suitable for entering longer text, such as a caption.
                      ),
                    ),
                    SizedBox(
                      height: 45,
                      ...
                      child: AspectRatio(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                            ...
                            image: MemoryImage(
                                _file!), //to display uint8list type image
                            fit: BoxFit.fill,
